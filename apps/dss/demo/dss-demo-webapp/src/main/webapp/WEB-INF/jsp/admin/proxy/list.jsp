		...
		<div class="table-container">
			<table class="data-table">
				...
				<tbody>
					...
					<tr>
						<td><a href="<spring:url value="/admin/proxy/edit?key=${preference.proxyKey}"/>"><spring:message code="${preference.proxyKey.keyName}"/></a></td>
						<td><a href="<spring:url value="/admin/proxy/edit?key=${preference.proxyKey}"/>">${preference.value}</a></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>		
