...
public class SignatureService_Service extends Service {
	...
	private final static URL SIGNATURE_SERVICE_WSDL_LOCATION;
	...
	public SignatureService_Service() {
		super(SIGNATURE_SERVICE_WSDL_LOCATION, new QName("http://impl.ws.dss.markt.ec.europa.eu/", "SignatureService"));
	}
