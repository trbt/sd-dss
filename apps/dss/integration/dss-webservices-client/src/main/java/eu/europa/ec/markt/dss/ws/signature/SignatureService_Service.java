...
@WebServiceClient(name = "SignatureService", targetNamespace = "http://impl.ws.dss.markt.ec.europa.eu/",
      wsdlLocation = "http://localhost:8080/dss-test/wservice/signatureService?wsdl")
...
//        }
        //System.out.println("ROOT_SERVICE_URL 2: " + ROOT_SERVICE_URL);
        //SignatureService_Service.ROOT_SERVICE_URL = ROOT_SERVICE_URL;
        try {
            SERVICE_WSDL_LOCATION = new URL(ROOT_SERVICE_URL + METHOD_URL);
        } catch (MalformedURLException e) {
