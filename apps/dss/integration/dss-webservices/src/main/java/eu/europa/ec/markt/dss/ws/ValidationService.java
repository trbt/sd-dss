 ...
 *
 * @version $Revision: 3369 $ - $Date: 2014-01-21 20:58:41 +0100 (Tue, 21 Jan 2014) $
 */
...
public interface ValidationService {
     ...
     * @param externalContent The original document before signing (used to verify detached signature)
    ...
    WSValidationReport validateDocument(@WebParam(name = "document") final WSDocument document, @WebParam(name = "externalContent") WSDocument externalContent,
