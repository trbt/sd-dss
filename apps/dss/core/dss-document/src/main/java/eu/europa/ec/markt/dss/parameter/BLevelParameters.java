...
*/
	...
	public String getSignaturePolicyId() {
		return signaturePolicy == null ? null : signaturePolicy.getId();
	}
	...
	public void setSignaturePolicyId(final String signaturePolicyId) {
		if (signaturePolicy != null) {
			...
			signaturePolicy.setId(signaturePolicyId);
		}
	}
	...
	public String getSignaturePolicyHashAlgo() {
		if (signaturePolicy != null) {
			...
			final DigestAlgorithm algo = signaturePolicy.getDigestAlgorithm();
			if (algo != null) {
	 ...
	 */
	@Deprecated
	public void setSignaturePolicyHashAlgo(final String signaturePolicyHashAlgo) {
		if (signaturePolicy != null) {

			signaturePolicy.setDigestAlgorithm(DigestAlgorithm.forName(signaturePolicyHashAlgo));
		}
	}
	...
	public byte[] getSignaturePolicyHashValue() {
		return signaturePolicy == null ? null : signaturePolicy.getDigestValue();
	}
	 ...
	 */
	@Deprecated
	public void setSignaturePolicyHashValue(final byte[] signaturePolicyHashValue) {
		if (signaturePolicy != null) {

			signaturePolicy.setDigestValue(signaturePolicyHashValue);
		}
	}
