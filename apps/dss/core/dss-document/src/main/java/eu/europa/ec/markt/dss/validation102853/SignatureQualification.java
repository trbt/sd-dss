...
public class SignatureQualification {
    ...
    public static void main(String[] args) {
        ...
        CertificateQualification certQ = new CertificateQualification();
        certQ.setQcc(true);
        certQ.setQcp(false);
        certQ.setQcpp(false);
        certQ.setQcsscd(false);

        TLQualification tlQ = new TLQualification();
        tlQ.setCaqc(true);
        tlQ.setQcCNoSSCD(false);
        tlQ.setQcForLegalPerson(false);
        tlQ.setQcSSCDAsInCert(false);
        tlQ.setQcWithSSCD(true);

        SignatureType st = SignatureQualification.getSignatureType(certQ, tlQ);
