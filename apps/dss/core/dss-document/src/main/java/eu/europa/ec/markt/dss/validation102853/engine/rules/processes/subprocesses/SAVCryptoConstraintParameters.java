...
public class SAVCryptoConstraintParameters extends ProcessParameters {
     ...
     * @param contextName
     */
    public SAVCryptoConstraintParameters(ProcessParameters params, String contextName) {

        this.currentTime = params.getCurrentTime();
        this.validationPolicy = params.getValidationPolicy();
        this.contextElement = params.getSignatureContext();
