...
public class Conclusion implements Indication, SubIndication, NodeName {
    ...
    public void addInfo(List<XmlDom> xmlDomInfoList) {

        if (xmlDomInfoList == null || xmlDomInfoList.isEmpty()) {
        ...
        for (final XmlDom xmlDom : xmlDomInfoList) {
    ...
    public Info getInfo(String attributeName, String attributeValue) {
    ...
    public void infoToXmlNode(XmlNode conclusion) {
