...
public class CryptographicVerification implements Indication, SubIndication, NodeName, NodeValue, AttributeName, AttributeValue, ExceptionMessage, ValidationXPathQueryHolder {
    ...
    private boolean process(final ProcessParameters params, final XmlNode conclusionNode) {
        ...
        final boolean referenceDataFound = contextElement.getBoolValue(REFERENCE_DATA_FOUND);
        ...
        final boolean referenceDataIntact = contextElement.getBoolValue(REFERENCE_DATA_INTACT);
        ...
        final boolean signatureIntact = contextElement.getBoolValue(SIGNATURE_INTACT);
