...
public class SAVCryptographicConstraint extends CryptographicConstraint {
    ...
    protected boolean process(final XmlNode infoContainerNode) {
        ...
        final String encryptionAlgo = contextElement.getValue(ENCRYPTION_ALGO_USED_TO_SIGN_THIS_TOKEN);
        ...
        String digestAlgo = contextElement.getValue(DIGEST_ALGO_USED_TO_SIGN_THIS_TOKEN);
        ...
        final String encryptionKeyLength = contextElement.getValue(KEY_LENGTH_USED_TO_SIGN_THIS_TOKEN);
