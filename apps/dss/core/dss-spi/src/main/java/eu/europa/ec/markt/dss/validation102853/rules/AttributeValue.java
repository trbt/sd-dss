...
public interface AttributeValue {
    ...
    public static final String BBB_SAV_ISQPCHP = "BBB_SAV_ISQPCHP";
    public static final String BBB_SAV_ISQPCTP = "BBB_SAV_ISQPCTP";
    public static final String BBB_SAV_ISQPCIP = "BBB_SAV_ISQPCIP";
    public static final String BBB_SAV_ISQPXTIP = "BBB_SAV_ISQPXTIP";
    public static final String BBB_SAV_ISQPCTSIP = "BBB_SAV_ISQPCTSIP";
    public static final String BBB_SAV_ISQPSLP = "BBB_SAV_ISQPSLP";
    public static final String BBB_SAV_ICRM = "BBB_SAV_ICRM";
    public static final String BBB_SAV_ICERRM = "BBB_SAV_ICERRM";
    ...
    public static final String SIGNATURE_PRODUCTION_PLACE = "SignatureProductionPlace";
    public static final String CONTENT_TYPE = "ContentType";
    public static final String COMMITMENT_TYPE_INDICATION_IDENTIFIER = "CommitmentTypeIndication.Identifier";
