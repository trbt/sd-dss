...
public interface NodeValue {
    ...
    public static final String BBB_SAV_ISQPCHP_LABEL = "Is signed qualifying properties: 'content-hints' present?";
    public static final String BBB_SAV_ISQPCHP_ANS_LABEL = "The signed qualifying properties: 'content-hints' is not present";

    public static final String BBB_SAV_ISQPCTP_LABEL = "Is signed qualifying properties: 'content type' present?";
    public static final String BBB_SAV_ISQPCTP_ANS_LABEL = "The signed qualifying properties: 'content type' is not present?";

    public static final String BBB_SAV_ISQPCIP_LABEL = "Is signed qualifying properties: 'content-identifier' present?";
    public static final String BBB_SAV_ISQPCIP_ANS_LABEL = "The signed qualifying properties: 'content-identifier' is not present?";

    public static final String BBB_SAV_ISQPCTSIP_LABEL = "Is signed qualifying properties: 'content-timestamp' present?";
    public static final String BBB_SAV_ISQPCTSIP_ANS_LABEL = "The signed qualifying properties: 'content-timestamp' is not present?";
    ...
    public static final String BBB_SAV_ICRM_LABEL = "Is the claimed role mandated?";
    public static final String BBB_SAV_ICERRM_LABEL = "Is the certified role mandated?";
    ...
    public static final String ADEST_IMIVC_ANS_LABEL = "Timestamp %s message imprint verification failed.";
