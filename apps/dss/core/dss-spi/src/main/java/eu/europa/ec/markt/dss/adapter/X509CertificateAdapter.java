...
public class X509CertificateAdapter extends XmlAdapter<String, X509Certificate> {
	 ...
	 */
	@Override
	public X509Certificate unmarshal(String value) throws Exception {

		InputStream inputStream = new ByteArrayInputStream(DSSUtils.base64Decode(value));
	...
	public String marshal(X509Certificate certificate) throws Exception {
		...
		return DSSUtils.base64Encode(certificate.getEncoded());
	}
